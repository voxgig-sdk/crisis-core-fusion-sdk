...
from core.control import CrisisCoreFusionControl
...
class CrisisCoreFusionContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CrisisCoreFusionControl()
        ...
        if isinstance(sp, CrisisCoreFusionSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CrisisCoreFusionResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CrisisCoreFusionResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CrisisCoreFusionOperation({})
    ...
    def make_error(self, code, msg):
        return CrisisCoreFusionError(code, msg, self)

# CrisisCoreFusion Python SDK

The Python SDK for the CrisisCoreFusion API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
# Create
created, _ = client.Fusion(None).create({"name": "Example"}, None)
...
result, err = client.CrisisCoreFusion(None).load(
    {"id": "test01"}, None
)
...
```
py/
├── crisiscorefusion_sdk.py         -- Main SDK module

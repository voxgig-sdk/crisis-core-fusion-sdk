# CrisisCoreFusion SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CrisisCoreFusionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CrisisCoreFusionSDK(...) and CrisisCoreFusionSDK.test(...) become
#      CrisisCoreFusionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "crisiscorefusion_sdk"
_SDK_CLASS = "CrisisCoreFusionSDK"

...
local MateriaEntity = {}
MateriaEntity.__index = MateriaEntity


function MateriaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MateriaEntity)
  self._name = "materia"
  self._client = client
...
function MateriaEntity:get_name()
  return self._name
end


function MateriaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MateriaEntity.new(self._client, opts)
end


function MateriaEntity:data_set(args)
  if args ~= nil then
...
function MateriaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MateriaEntity:match_set(args)
  if args ~= nil then
...
function MateriaEntity:match_get()
...
function MateriaEntity:stream(action, args, callopts)
...
function MateriaEntity:_run_op(ctx, post_done)
  local utility = self._utility

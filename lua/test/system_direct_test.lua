...
describe("SystemDirect", function()
  it("should direct-load-system", function()
    local setup = system_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-system", setup.live and "live" or "unit")
...
function system_direct_setup(mockres)

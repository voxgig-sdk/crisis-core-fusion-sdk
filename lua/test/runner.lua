...
function runner.env_override(m)
  local live = runner.getenv("CRISISCOREFUSION_TEST_LIVE")
  local override = runner.getenv("CRISISCOREFUSION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CRISISCOREFUSION_TEST_EXPLAIN")

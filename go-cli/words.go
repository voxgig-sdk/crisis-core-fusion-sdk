...
func registerSDKWords(r *eng.Registry, client *sdk.CrisisCoreFusionSDK) {
...
func runOp(client *sdk.CrisisCoreFusionSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

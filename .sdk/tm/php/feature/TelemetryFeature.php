...
// CrisisCoreFusion SDK telemetry feature
...
class CrisisCoreFusionTelemetryFeature extends CrisisCoreFusionBaseFeature
{
    ...
    private function _close(CrisisCoreFusionContext $ctx, bool $ok): void
    {

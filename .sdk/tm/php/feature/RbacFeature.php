...
// CrisisCoreFusion SDK rbac feature
...
class CrisisCoreFusionRbacFeature extends CrisisCoreFusionBaseFeature
{
    ...
    private function _required(CrisisCoreFusionContext $ctx): ?string
    {
    ...
    private function _reject(CrisisCoreFusionContext $ctx, string $required): void
    {
    ...
    private function _track(CrisisCoreFusionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

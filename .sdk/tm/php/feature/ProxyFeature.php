...
// CrisisCoreFusion SDK proxy feature
...
class CrisisCoreFusionProxyFeature extends CrisisCoreFusionBaseFeature
{
    ...
    public function init(CrisisCoreFusionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CrisisCoreFusionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

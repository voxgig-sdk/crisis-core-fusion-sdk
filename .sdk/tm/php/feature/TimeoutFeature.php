...
// CrisisCoreFusion SDK timeout feature
...
class CrisisCoreFusionTimeoutFeature extends CrisisCoreFusionBaseFeature
{
    ...
    private function _with_timeout(CrisisCoreFusionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CrisisCoreFusionContext $_ctx, float $ms): void
    {
        $client = $this->client;

...
// CrisisCoreFusion SDK clienttrack feature
...
class CrisisCoreFusionClienttrackFeature extends CrisisCoreFusionBaseFeature
{
    ...
    public function PostConstruct(CrisisCoreFusionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CrisisCoreFusion-SDK';

...
// CrisisCoreFusion SDK netsim feature
...
class CrisisCoreFusionNetsimFeature extends CrisisCoreFusionBaseFeature
{
    ...
    private function _simulate(CrisisCoreFusionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CrisisCoreFusionContext $ctx, array $applied): void
    {
        $client = $this->client;

...
// CrisisCoreFusion SDK ratelimit feature
...
class CrisisCoreFusionRatelimitFeature extends CrisisCoreFusionBaseFeature
{
    ...
    private function _acquire(CrisisCoreFusionContext $ctx): void
    {
    ...
    private function _track(CrisisCoreFusionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

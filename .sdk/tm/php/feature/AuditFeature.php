...
// CrisisCoreFusion SDK audit feature
...
class CrisisCoreFusionAuditFeature extends CrisisCoreFusionBaseFeature
{
    ...
    private function _emit(CrisisCoreFusionContext $ctx, string $outcome): void
    {

...
// CrisisCoreFusion SDK utility type

class CrisisCoreFusionUtility
{
    ...
    public static function copy(CrisisCoreFusionUtility $src): CrisisCoreFusionUtility
    {
        $u = new CrisisCoreFusionUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

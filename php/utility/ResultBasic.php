...
// CrisisCoreFusion SDK utility: result_basic

class CrisisCoreFusionResultBasic
{
    public static function call(CrisisCoreFusionContext $ctx): ?CrisisCoreFusionResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof CrisisCoreFusionError) ? $result->err->msg : (string)$result->err;

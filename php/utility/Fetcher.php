...
// CrisisCoreFusion SDK utility: fetcher

class CrisisCoreFusionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CrisisCoreFusionSDK/1.0)';
    ...
    public static function call(CrisisCoreFusionContext $ctx, string $fullurl, array $fetchdef): array
    {

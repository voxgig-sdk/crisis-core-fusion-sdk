...
The PHP SDK for the CrisisCoreFusion API. Provides an entity-oriented interface using PHP conventions.
...
```php
// Create
[$created, $_] = $client->Fusion(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->CrisisCoreFusion(null)->load(
    ["id" => "test01"], null
);

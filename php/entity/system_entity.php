...
// CrisisCoreFusion SDK System entity
...
class SystemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SystemEntity($this->_client, $opts);
    }

    /**
     * @param System|array $args System data (assoc-array) to store.
     */
    ...
    /**
     * @return System|array The current System data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of System fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of System fields).
     */
     ...
     *
     * @param SystemLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SystemLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return System|array The loaded System as an assoc-array at the

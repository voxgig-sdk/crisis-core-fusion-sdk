...
class FusionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FusionEntity($this->_client, $opts);
    }

    /**
     * @param Fusion|array $args Fusion data (assoc-array) to store.
     */
    ...
    /**
     * @return Fusion|array The current Fusion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Fusion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Fusion fields).
     */
     ...
     * Create a new Fusion.
     *
     * @param FusionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FusionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Fusion|array The created Fusion as an assoc-array at the

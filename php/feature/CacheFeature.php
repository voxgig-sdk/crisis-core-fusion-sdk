...
// CrisisCoreFusion SDK cache feature
...
class CrisisCoreFusionCacheFeature extends CrisisCoreFusionBaseFeature
{
    ...
    private function _through(CrisisCoreFusionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
// CrisisCoreFusion SDK metrics feature
...
class CrisisCoreFusionMetricsFeature extends CrisisCoreFusionBaseFeature
{
    ...
    private function _record(CrisisCoreFusionContext $ctx, bool $ok): void
    {

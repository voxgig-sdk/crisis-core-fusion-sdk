...
// CrisisCoreFusion SDK streaming feature
...
class CrisisCoreFusionStreamingFeature extends CrisisCoreFusionBaseFeature
{
    ...
    private function _iterate(CrisisCoreFusionResult $result): \Generator
    {
    ...
    private function _streamable(CrisisCoreFusionContext $ctx): bool
    {

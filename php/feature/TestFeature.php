...
// CrisisCoreFusion SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CrisisCoreFusionTestFeature extends CrisisCoreFusionBaseFeature
{
    ...
    public function init(CrisisCoreFusionContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CrisisCoreFusionContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CrisisCoreFusionParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CrisisCoreFusionContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CrisisCoreFusionContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = CrisisCoreFusionParam::call($ctx, $k);

...
class CrisisCoreFusionTestRunner
{
    ...
    {
        $live = self::getenv('CRISISCOREFUSION_TEST_LIVE');
        $override = self::getenv('CRISISCOREFUSION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CRISISCOREFUSION_TEST_EXPLAIN');
...
class_alias('CrisisCoreFusionTestRunner', 'Runner');
class_alias('CrisisCoreFusionHelpers', 'Helpers');

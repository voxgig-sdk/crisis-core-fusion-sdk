...
class SystemDirectTest extends TestCase
{
    public function test_direct_load_system(): void
    {
        $setup = system_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-system", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

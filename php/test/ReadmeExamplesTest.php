...
// CrisisCoreFusion SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CrisisCoreFusionSDK::test)
...
{
    private const SDK_CLASS = 'CrisisCoreFusionSDK';
    ...
    private const SDK_BASE = 'crisiscorefusion_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../crisiscorefusion_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

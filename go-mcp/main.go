// Command CrisisCoreFusion-mcp is an MCP server exposing the CrisisCoreFusion
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CrisisCoreFusion_list  — list records of an entity
//	CrisisCoreFusion_load  — load a single record of an entity
//

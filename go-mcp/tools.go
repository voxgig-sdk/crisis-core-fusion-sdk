...
type Args struct {
	Entity string         `json:"entity" jsonschema:"fusion | materia | system"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CrisisCoreFusionSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "crisis-core-fusion_list",
		Description: "List records from CrisisCoreFusion. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "crisis-core-fusion_load",
		Description: "Load a single record from CrisisCoreFusion. " +
...
func runOp(client *sdk.CrisisCoreFusionSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CrisisCoreFusionSDK, name string) (sdk.CrisisCoreFusionEntity, error) {
	switch strings.ToLower(name) {
	case "fusion":
		return client.Fusion(nil), nil
	case "materia":
		return client.Materia(nil), nil
	case "system":

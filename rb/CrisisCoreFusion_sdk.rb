...
require_relative 'CrisisCoreFusion_types'
...
class CrisisCoreFusionSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = CrisisCoreFusionHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = CrisisCoreFusionHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, CrisisCoreFusionFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    CrisisCoreFusionUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = CrisisCoreFusionHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = CrisisCoreFusionHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = CrisisCoreFusionHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def direct(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = CrisisCoreFusionHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = CrisisCoreFusionSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end

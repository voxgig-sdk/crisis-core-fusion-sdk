...
The Ruby SDK for the CrisisCoreFusion API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
```ruby
# Create
created, _ = client.Fusion(nil).create({ "name" => "Example" }, nil)
...
result, err = client.CrisisCoreFusion(nil).load(
  { "id" => "test01" }, nil
)

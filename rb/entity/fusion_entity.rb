...
class FusionEntity
  ...
  # @return [Fusion, Hash] the current Fusion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Fusion fields)
  def match_get
  ...
  # Create a new Fusion.
  #
  # @param reqdata [FusionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Fusion, Hash] the created Fusion; raises CrisisCoreFusionError on failure

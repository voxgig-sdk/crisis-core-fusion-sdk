...
#      offline in seeded test mode (CrisisCoreFusionSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CrisisCoreFusion_sdk.rb")
  SDK_CLASS = "CrisisCoreFusionSDK"

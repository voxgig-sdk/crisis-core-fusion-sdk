...
module CrisisCoreFusionTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("CRISISCOREFUSION_TEST_LIVE")
    override = getenv("CRISISCOREFUSION_TEST_OVERRIDE")
    ...
    explain = getenv("CRISISCOREFUSION_TEST_EXPLAIN")
    m["CRISISCOREFUSION_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CrisisCoreFusionTestRunner
Helpers = CrisisCoreFusionHelpers
Vs = VoxgigStruct

...
The TypeScript SDK for the CrisisCoreFusion API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new CrisisCoreFusionSDK({ apikey: '...' })

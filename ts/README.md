# CrisisCoreFusion TypeScript SDK



The TypeScript SDK for the CrisisCoreFusion API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Fusion()` — each with a small set of operations (`list`, `load`, `create`)
...
```ts
new CrisisCoreFusionSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `CrisisCoreFusionSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `CrisisCoreFusionSDK.test(testopts?, sdkopts?)` | `CrisisCoreFusionSDK` | Create a test-mode client. |
...
crisis-core-fusion/
├── src/
│   ├── CrisisCoreFusionSDK.ts        # Main SDK class

# CrisisCoreFusion TypeScript SDK Reference

Complete API reference for the CrisisCoreFusion TypeScript SDK.
...
```ts
new CrisisCoreFusionSDK(options?: object)
```
...
#### `CrisisCoreFusionSDK.test(testopts?, sdkopts?)`
...
**Returns:** `CrisisCoreFusionSDK` instance in test mode.
...
Create a new `Fusion` entity instance.
...
**Returns:** `FusionEntity` instance.

#### `Materia(data?: object)`

Create a new `Materia` entity instance.
...
**Returns:** `MateriaEntity` instance.
...
Alias for `CrisisCoreFusionSDK.test()`.
...
Return the parent `CrisisCoreFusionSDK` instance.

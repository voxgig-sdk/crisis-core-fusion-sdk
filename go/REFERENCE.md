# CrisisCoreFusion Golang SDK Reference

Complete API reference for the CrisisCoreFusion Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *CrisisCoreFusionSDK`
...
#### `Fusion(data map[string]any) CrisisCoreFusionEntity`

Create a new `Fusion` entity instance. Pass `nil` for no initial data.

#### `Materia(data map[string]any) CrisisCoreFusionEntity`

Create a new `Materia` entity instance. Pass `nil` for no initial data.

#### `System(data map[string]any) CrisisCoreFusionEntity`

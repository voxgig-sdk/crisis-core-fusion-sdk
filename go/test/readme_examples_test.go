...
const testSeed = `map[string]any{"entity": map[string]any{"fusion": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "materia": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "system": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
